...
// Note the Volz DA26 and UAVOS serial protocols are nearly identical except for the set_position and report_position commands.
...
private:
    ...
    // Protcol Dependent Settings
    // uint16_t _min_position;
    // uint16_t _center_position;
    // uint16_t _max_position;
};
