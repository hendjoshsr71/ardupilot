...
public:
    ...
    // target_vel is updated with the target velocity in NE frame
...
private:
    ...
    // interval variables
    Vector3f    _origin;                // origin offset (in NED frame) from EKF
    Vector3f    _destination;           // destination offset (in NED frame) from EKF
