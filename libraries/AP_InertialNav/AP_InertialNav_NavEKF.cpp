...
{
    return -_relpos_cm.z;  // Might need to convert to NEU here from NED // Convert here to NEU from NED to rid ourselves of NEU in steps DELETE
}
...
{
    return -_velocity_cm.z; // Might need to convert to NEU here from NED // Convert here to NEU from NED to rid ourselves of NEU in steps DELETE
}
