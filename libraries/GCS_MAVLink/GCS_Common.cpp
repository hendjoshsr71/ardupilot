...
void GCS_MAVLINK::send_smart_battery_info(const uint8_t instance) const
{
    ...
    const int32_t capacity_full = battery.pack_capacity_mah(instance);
    ...
    mavlink_msg_smart_battery_info_send(
        ...
        capacity_full ? capacity_full : -1,         // [mAh] Capacity when full (accounting for battery degradation), -1: field not provided.
