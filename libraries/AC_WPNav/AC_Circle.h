...
public:
    ...
    float get_radius() const { return is_positive(_radius) ? _radius : _radius_parm * 0.01; }
    ...
    bool update(float climb_rate = 0.0) WARN_IF_UNUSED;
    ...
    float get_distance_to_target() const { return _pos_control.get_pos_error_xy_cm() * 0.01; }
...
private:
    ...
    // internal variables
    Vector3p    _center;        // center of circle frame NED in meters from home
