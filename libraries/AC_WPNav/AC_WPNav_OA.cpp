...
float AC_WPNav_OA::get_wp_distance_to_destination() const
{
    ...
    return get_horizontal_distance_cm(_inav.get_position_xy() * 100.0, _destination_oabak.xy());
}
...
int32_t AC_WPNav_OA::get_wp_bearing_to_destination() const
{
    ...
    return get_bearing_cd(_inav.get_position_xy() * 100.0, _destination_oabak.xy());
}
