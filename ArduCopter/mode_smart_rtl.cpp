...
bool ModeSmartRTL::get_target_info(uint16_t &type_mask, Location &target, Vector3f &target_vel, Vector3f &target_accel) const
{
    ...
    case SubMode::DESCEND:
        ...
        return wp_nav->get_wp_destination_loc(target);
    case SubMode::LAND:
        return false;
    }
