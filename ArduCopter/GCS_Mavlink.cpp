...
void GCS_MAVLINK_Copter::send_position_target_local_ned()
{
    ...
    case ModeGuided::SubMode::WP:
        ...
        target_pos = copter.wp_nav->get_wp_destination();
    ...
    case MAVLINK_MSG_ID_SET_ATTITUDE_TARGET:   // MAV ID: 82
    {
        ...
        if (use_thrust) {
            ...
            if (is_equal(packet.thrust, 0.5f)) {
                ...
                climb_rate_or_thrust = (packet.thrust - 0.5f) * 2.0f * copter.wp_nav->get_default_speed_up() * 100.0f; // conver m to cm
            } else {
                // descend at up to WPNAV_SPEED_DN
                climb_rate_or_thrust = (0.5f - packet.thrust) * 2.0f * -fabsf(copter.wp_nav->get_default_speed_down() * 100.0f); // convert m to cm
            }
        }
