...
bool ModeRTL::init(bool ignore_checks)
{
    ...
    wp_nav->wp_and_spline_init(g.rtl_speed_cms * 0.01f);
...
void ModeRTL::descent_start()
{
    ...
    loiter_nav->init_target(wp_nav->get_wp_destination().neu_to_ned() * 100.0f); // convert m to cm // takes neu
...
void ModeRTL::build_path()
{
    ...
    rtl_path.origin_point = Location(stopping_point.neu_to_ned(), Location::AltFrame::ABOVE_ORIGIN); // Location uses NED
